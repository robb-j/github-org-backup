#!/usr/bin/env deno run --env --allow-env --allow-write=. --allow-read=. --allow-net=api.github.com:443,ghcr.io:443,pkg-containers.githubusercontent.com:443 --allow-run=git
